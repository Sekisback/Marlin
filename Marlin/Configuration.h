...
#define STRING_CONFIG_H_AUTHOR "(SEK, Wizzard)" // Who made the changes.
 ...
 * Override with M92
 *                                      X, Y, Z, E0 [, E1[, E2...]]
 * #define DEFAULT_AXIS_STEPS_PER_UNIT   { 80, 80, 400, 97.8 }  // normal extruder
 * #define DEFAULT_AXIS_STEPS_PER_UNIT   { 80, 80, 400, 141.8 } // dual gear extruder
 */
...
//#define MANUAL_PROBE_START_Z 0.05
 ...
 *     O-- FRONT --+
 */
#define NOZZLE_TO_PROBE_OFFSET { -43, -10, -0.80 }
...
#define MANUAL_Y_HOME_POS -6 // #define MANUAL_Y_HOME_POS -6
